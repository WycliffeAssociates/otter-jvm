...
class CollectionRepository(
        ...
        private val relatedCollectionMapper: RelatedCollectionMapper = RelatedCollectionMapper(
                collectionMapper,
                ChunkMapper()
        )
    ...
    override fun insertRelatedCollection(related: RelatedCollection): Completable {
        return Completable
                .fromAction {
                    // Build up list of entities
                    val relatedEntity = relatedCollectionMapper.mapToEntity(related)
